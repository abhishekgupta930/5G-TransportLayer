...
CalculateThroughput ()
{
  ...
  std :: ofstream myfile;
  myfile.open ("Building_Throughput.txt",std :: fstream::app);
...
*/
  ...
  switch (scenario)
	...
	Ptr < Building > building1;
        ...
        building1->SetBoundaries (Box (20.0,30.0,
                                       0.0, 2.0,
                                       0.0, 15));

        Ptr < Building > building2;
        building2 = Create<Building> ();
        building2->SetBoundaries (Box (20.0,30.0,
                                       -4.0, -2.0,
                                       0.0, 15.0));
  ...
  if (tcp)
  ...
  else
    {
      ...
      Ptr<MyApp> app = CreateObject<MyApp> ();
      app->Setup (ns3UdpSocket, sinkAddress, 1400, 50000000, DataRate ("1Gb/s"));
